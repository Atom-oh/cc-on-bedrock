...
## Status
Accepted (2026-05-12) — supersedes [ADR-013](archive/ADR-013-unified-cloudfront-auth.md). Split implemented (DevenvCf in Stack 04, DashboardCf in Stack 05); `lambda/devenv-origin-router/` archived per Migration Plan Step 4.
