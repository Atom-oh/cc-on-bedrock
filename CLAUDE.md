...
## Conventions
- Repository documentation, ADRs, review artifacts and code comments are English-only by owner direction. Operator conversation may be Korean; historical bilingual records do not require new Korean duplicates.
