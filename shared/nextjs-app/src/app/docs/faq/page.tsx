    ...
    <div className="max-w-4xl mx-auto">
      ...
      <FaqSection title={ko ? "개발 환경" : "Development Environment"}>
        ...
        <FaqItem
          ...
          a={ko
            ? "Claude Opus 4.6 (최고 성능)과 Claude Sonnet 5 (빠른 응답)을 사용할 수 있습니다. 모델 선택은 Claude Code/Kiro 내에서 자유롭게 전환 가능합니다."
            : "Claude Opus 4.6 (highest performance) and Claude Sonnet 5 (fast response). You can freely switch between models within Claude Code/Kiro."}
        />
        <FaqItem
